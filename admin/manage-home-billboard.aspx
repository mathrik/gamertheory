<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="manage-home-billboard.aspx.cs" Inherits="admin_manage_home_billboard" %>
...
<table class="account-form">
    ...
    <tr>
        <td align="right"><asp:Label ID="Label1" AssociatedControlID="fileBillboard" runat="server">New File: (710x260) </asp:Label></td>
